                    ...
                    <form action="{{ route('store.video') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                ...
                                <input type="url" name="link" class="form-control form-control-sm mb-2 shadow-none @error('link') is-invalid @enderror" id="link" placeholder="Enter Video Link">
                                @error('link')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            @forelse ($video as $key=>$item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ url('video/delete/'.$item->id) }}" type="submit" class="btn btn-danger btn-mod-danger btn-sm" onclick="return confirm('Are you sure?')"><i class="fas fa-trash"></i></button>
                                    </td>
                                </tr>
                            @empty
                                <tr>
