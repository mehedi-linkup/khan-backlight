@extends('layouts.admin-master', ['pageName'=> 'cancelled', 'title' => 'Cancelled Orders'])
                            ...
                            @forelse ($order as $key=>$item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a style="padding-left: 5px" href="{{ route('order.pdeleted', $item->id) }}" class="d-inline" onclick="return confirm('Are you sure you want to delete?');"><i class="fas fa-trash" style="color: red"></i></a>  
                                    </td>                          
                                </tr>
                            @empty
                                <tr>
